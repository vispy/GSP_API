...
- Current stage: S013 VisPy2 semantic guide API growth.
...
- M016 VisPy2 label/title/tick/grid APIs is complete.
- Next mission: M017 VisPy2 examples and guide API tests.
