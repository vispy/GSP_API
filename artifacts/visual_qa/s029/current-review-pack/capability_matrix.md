...
| `text/basic_ndc` | datoviz | unsupported | `datoviz_text_contract_unverified` | False | False |
| `text/anchor_grid_ndc` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `text/anchor_grid_ndc` | datoviz | unsupported | `datoviz_text_contract_unverified` | False | False |
| `text/rotation_alpha_ndc` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `text/rotation_alpha_ndc` | datoviz | unsupported | `datoviz_text_contract_unverified` | False | False |
| `text/data_vs_ndc` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `text/data_vs_ndc` | datoviz | unsupported | `datoviz_text_contract_unverified` | False | False |
| `text/multiline_unicode_smoke` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `text/multiline_unicode_smoke` | datoviz | unsupported | `datoviz_text_contract_unverified` | False | False |
| `mesh/single_triangle_uniform_ndc_2d` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `mesh/single_triangle_uniform_ndc_2d` | datoviz | unsupported | `datoviz_mesh_contract_unverified` | False | False |
| `mesh/indexed_square_uniform_ndc_2d` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `mesh/indexed_square_uniform_ndc_2d` | datoviz | unsupported | `datoviz_mesh_contract_unverified` | False | False |
| `mesh/indexed_square_per_face_ndc_2d` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `mesh/indexed_square_per_face_ndc_2d` | datoviz | unsupported | `datoviz_mesh_contract_unverified` | False | False |
| `color/scalar_image_viridis_colorbar` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `color/scalar_image_viridis_colorbar` | datoviz | unsupported | `qa_datoviz_color_scales_not_wired` | False | False |
| `color/point_scalar_gray_range` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `color/point_scalar_gray_range` | datoviz | unsupported | `qa_datoviz_color_scales_not_wired` | False | False |
| `color/marker_scalar_fill_alpha` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `color/marker_scalar_fill_alpha` | datoviz | unsupported | `datoviz_scalar_visual_family_unsupported` | False | False |
| `transform/inline_named_equivalence` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `transform/inline_named_equivalence` | datoviz | unsupported | `datoviz_named_transform_unresolved` | False | False |
| `transform/view2d_data_ndc_overlay` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `transform/view2d_data_ndc_overlay` | datoviz | unsupported | `datoviz_data_coordinates_unsupported` | False | False |
| `transform/family_affine_view2d` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `transform/family_affine_view2d` | datoviz | unsupported | `datoviz_data_coordinates_unsupported` | False | False |
| `guide/view2d_auto_grid` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `guide/view2d_auto_grid` | datoviz | unsupported | `datoviz_data_coordinates_unsupported` | False | False |
| `guide/view2d_reversed_explicit` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `guide/view2d_reversed_explicit` | datoviz | unsupported | `datoviz_data_coordinates_unsupported` | False | False |
