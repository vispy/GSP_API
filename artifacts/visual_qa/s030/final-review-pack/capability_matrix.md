...
| `text/anchor_grid_ndc` | datoviz | adapted | `datoviz_rendered_pending_promotion_audit` | True | False |
| `text/rotation_alpha_ndc` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `text/rotation_alpha_ndc` | datoviz | strict | `datoviz_rendered_strict_s029_family_audit` | True | False |
| `text/data_vs_ndc` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `text/data_vs_ndc` | datoviz | adapted | `datoviz_rendered_pending_promotion_audit` | True | False |
...
| `guide/view2d_auto_grid` | datoviz | adapted | `datoviz_axis_guide_adapted_review` | True | False |
| `guide/view2d_reversed_explicit` | matplotlib | strict | `matplotlib_reference_rendered` | True | False |
| `guide/view2d_reversed_explicit` | datoviz | adapted | `datoviz_axis_guide_adapted_review` | True | False |
