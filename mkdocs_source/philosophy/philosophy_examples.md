...
**Demonstrated in:** [`session_01_record_example.py`](https://github.com/vispy/GSP_API/blob/main/examples/session_01_record_example.py), [`session_02_player_example.py`](https://github.com/vispy/GSP_API/blob/main/examples/session_02_player_example.py).
...
3. **For the env-var name** — `grep -rn "GSP_RENDERER" examples/ src/`. [example_helper.py:42](https://github.com/vispy/GSP_API/blob/main/examples/common/example_helper.py#L42) uses `GSP_RENDERER`; user-facing docs should follow that source of truth.
