...
| `gsp_vispy2@0.2` | `visual.mesh` | **strict** | accepted indexed mesh, color, flat Lambert, and nearest-or-linear Texture2D record production | — |
...
| `gsp.datoviz-v0.4@0.2` | `mesh.texture2d-unlit` | **strict** | RGBA8 vertex-UV unlit meshes with visual-owned nearest-or-linear clamp/no-mipmap field-slot sampling | base-level unmanaged numeric sampling only; non-opaque 3D depth remains non-strict |
