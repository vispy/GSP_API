...
class ViewportEventsNetwork(ViewportEventsBase):
    ...
    def __init__(self, renderer: NetworkRenderer, viewport: Viewport) -> None:
        ...
        self._mpl_mouse_scroll_cid: int | None = mpl_canvas.mpl_connect("scroll_event", typing.cast(Any, self._on_mouse_scroll))
        self._mpl_resize_cid: int | None = mpl_canvas.mpl_connect("resize_event", typing.cast(Any, self._on_canvas_resize))
