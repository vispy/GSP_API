...
def main():
    ...
    viewport_1 = Viewport(0, 0, canvas_half_width, canvas_half_height, Constants.Color.transparent)
    viewport_2 = Viewport(canvas_half_width, canvas_half_height, canvas_half_width, canvas_half_height, Constants.Color.transparent)
