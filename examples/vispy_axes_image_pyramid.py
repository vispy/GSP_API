...
## Glossary
- a value is a 16 bits
- a sample is 30 values, one per channel, at a given time point
...
class PyramidConfig:
    ...
    max_zoomout: int = 9
    """Maximum zoomout level (2^9 = 512x downsampling)."""

    min_zoomout: int = 0
    """Minimum zoomout level (2^0 = 1x downsampling)."""
