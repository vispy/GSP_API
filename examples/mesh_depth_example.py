"""Example rendering a mesh with MeshDepthMaterial (face colors derived from view-space depth)."""
...
def main():
    ...
    mesh_material = MeshDepthMaterial(edge_colors_buffer, edge_widths_buffer, True, Constants.FaceCulling.FrontSide)
