...
def main(save_video: bool):
    ...
    # renderer_datoviz = DatovizRenderer(canvas)
    # renderer_base = typing.cast(RendererBase, renderer_datoviz)

    # renderer_base.render([viewport], [points], [model_matrix], [camera])
    # renderer_base.show()
