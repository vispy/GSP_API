"""Example rendering a mesh with MeshNormalMaterial (face colors derived from view-space normals)."""
...
def main():
    ...
    mesh_material = MeshNormalMaterial(edge_colors_buffer, edge_widths_buffer, True, Constants.FaceCulling.FrontSide)
