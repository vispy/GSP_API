...
class PyramidTextureHelper:
    ...
    @staticmethod
    def texture_load(zoomout_level: int, axes_display: AxesDisplay, image_x_min_dunit: float, image_x_max_dunit: float) -> Texture:
...
class PyramidImageHelper:
    ...
    def image_update(axes_display: AxesDisplay, image: Image) -> None:
        ...
        texture = PyramidTextureHelper.texture_load(texture_zoomout_level, axes_display, image_x_min_dunit, image_x_max_dunit)
