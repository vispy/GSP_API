# Prompt White Paper for {{repo_name}}
You are an expert technical writer and systems architect.

Your task is to write a rigorous, high-quality white paper for a software repository.
...
Produce a professional white paper that is:

* technically precise
* structured like a real industry document
* persuasive but not marketing fluff
* grounded in system design and trade-offs
...
1. Title & Abstract
   ...
   * Clear positioning
   * 5–8 sentence abstract summarizing the system and its significance
...
6. Key Features
   ...
   * Explain each feature with reasoning
   * Include trade-offs

7. Technical Deep Dive

   * Algorithms, protocols, or core mechanisms
...
9. Comparison with Existing Solutions
   ...
   * Concrete comparison (not vague claims)
...
* No vague claims without explanation
* Prefer precise language over marketing tone
* Use diagrams descriptions where useful (in text form)
