...
| [`vispy2`](../../src/vispy2/) | High-level matplotlib-like facade: `scatter`, `plot`, `imshow`, plus axis tick locating and formatting helpers |
...
2. The session record/replay examples — see [philosophy_examples.md §4.8](./philosophy_examples.md) and [examples/session_01_record_example.py](../../examples/session_01_record_example.py).
...
| Module | Exports |
|---|---|
| [`vispy2.axes`](../../src/vispy2/axes/__init__.py) | `AxisTickLocator`, `AxisTickFormatter` |
